 ...
 */
Hcode H_encode(Hcode &h,Point p, const U_int DIM, const U_int* g_mask)
{
    U_int   mask = (U_int)1 << WORDBITS - 1, element, temp1, temp2,
        A, W = 0, S, tS, T, tT, J, P = 0, xJ;
/*    Hcode   h = {0};*/
/*    Hcode h;*/
/*    h.hcode=(U_int *)callo(DIM,sizeof(U_int));*/
 ...
 * on the Hilbert Curve
 */
Point H_decode (Point &pt,Hcode H, const U_int DIM, const U_int* g_mask)
{
    U_int   mask = (U_int)1 << WORDBITS - 1, element, temp1, temp2,
        A, W = 0, S, tS, T, tT, J, P = 0, xJ;
/*    Point   pt = {0};*/
/*    Point pt;*/
/*    pt.hcode=(U_int *)calloc(DIM,sizeof(U_int));*/
    int i = NUMBITS * DIM - DIM, j;
...
/*    int i,j;*/
/*    int dim=3;*/
/*    U_int *g_mask=(U_int *)calloc(dim,sizeof(U_int));*/
/*    for(i=0;i<dim;i++){*/
/*        g_mask[i]=1<< dim-1-i;      */
/*    }*/
/*    for(i=0;i<64;i++){*/
/*        Hcode h;*/
/*        h.hcode=(U_int *)calloc(dim,sizeof(U_int));*/
/*        h.hcode[0]=i;*/
/*        h.hcode[1]=0;*/
/*        Hcode a; */
/*        a.hcode=(U_int *)calloc(dim,sizeof(U_int));*/
/*        H_decode(a,h,dim,g_mask);*/
/*        for(j=0;j<dim;j++){*/
/*            printf("%d ",a.hcode[j]);*/
/*        }*/
/*        printf("\n");*/
/*        Hcode b;*/
/*        b.hcode=(U_int *)calloc(dim,sizeof(U_int));*/
/*        H_encode(b,a,dim,g_mask);*/
/*        for(j=0;j<dim;j++){*/
/*            printf("%d ",b.hcode[j]);*/
/*        }*/
/*        printf("\n");*/
